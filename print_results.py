...
def print_results(results_dic, results_stats_dic, model, 
   ...
   # Prints summary statistics over the run
    ...
    print(" ")
    #print("results_stats_dic values = ", results_stats_dic)
    for key in results_stats_dic:
        ...
        #print("key value =", key)
        #print("key[0] value =", key[0])
        #rint("results_stats_dic values
        if key[0] == 'p':
            new_key = key.replace('_',' ').title()
            print("{:20}: {:6.2f}%".format(new_key, results_stats_dic[key]))
